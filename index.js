...
const privacyPolicyController = require('./controllers/Index/privacy-policy');
const termsOfServiceController = require('./controllers/Index/terms-of-service');
const FAQController = require('./controllers/Index/FAQ');
...
app.get('/terms-of-service', termsOfServiceController);

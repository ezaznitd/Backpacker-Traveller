...
app.get('/single-post-:postType-:postTitle-:id', getPostController);
app.get('/single-video-:postType-:postTitle-:id', getReviewController);
app.get('/:stateName-:locationName-single-travelPost-:postTitle-:postId', getTravelPostController);

...
const deleteFAQController = require('./controllers/FAQ/delete-FAQ');
...
const getFAQDeleteController = require('./controllers/FAQ/get-FAQ-delete');
...
const storeSubscriberController = require('./controllers/Subscriber/storeSubscriber');
...
const storeSubscriber = require('./middleware/Subscriber/storeSubscriber');
...
app.post('/subscriber/store/', storeSubscriber, storeSubscriberController);
...
app.post('/get/FAQ/delete/', deleteFAQController);
...
app.get('/delete/FAQ/', getFAQDeleteController);
